...
from menus import inventory_menu, level_up_menu, character_menu
...
def render_all(con, panel, entities, player, game_map, fov_map, fov_recompute, message_log, screen_width, screen_height,
 bar_width, panel_height, panel_y, mouse, colors, game_state):
	...
	for entity in entities_in_render_order:
		...
		libtcod.console_print_ex(panel, 1, 0, libtcod.BKGND_NONE, libtcod.LEFT, get_name_under_mouse(mouse, entities, fov_map))
	...
	if game_state in (GameStates.SHOW_INVENTORY, GameStates.DROP_INVENTORY):
		...
		level_up_menu(con, 'Level up! Schoose a stat to raise:', player, 40, screen_width, screen_height)

	elif game_state == GameStates.CHARACTER_SCREEN:
		character_menu(player, 30, 10, screen_width, screen_height)
